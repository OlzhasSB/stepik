...
struct Data {
    ...
    var movies: [Movie] = [
        ...
        Movie.init(title: "The Batman", releaseDate: "2022-03-04", voteAverage: "★7.5", posterPath: UIImage.init(named: "batman.jpeg"), details: "Batman ventures into Gotham City's underworld when a sadistic killer leaves behind a trail of cryptic clues. As the evidence begins to lead closer to home and the scale of the perpetrator's plans become clear, he must forge new relationships, unmask the culprit and bring justice to the abuse of power and corruption that has long plagued the metropolis.", poster: UIImage.init(named: "batman_cover.jpeg"), actors: [
